...
typedef struct tag_class07_blockload_entry_t
{
	...
	Integer32	blockkWh_value;		/* Block Energy � kWh */
	Integer32	PhEffCurrent;		/* Ph or Effective Current  */
	Integer32	block_demand;		/* avg. power factor*/
	Integer32	blockkVAh_value;	/* Block Energy � kVAh */
	Integer32	NuCuurent;			/* Neutral Current */
	Integer32	blockPf;			/* block Pf  */
...
typedef struct tag_class07_event_entry_t
{
	...
	Integer32		active_energy;			/* Cumulative Energy - kWh */
	Integer32		nu_current_value;		/* neutral current */
	Integer32		eff_current_value;		/* effective Current  */
